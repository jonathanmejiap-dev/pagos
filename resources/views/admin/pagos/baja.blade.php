...
@section('content')
    ...
    <div class="mb-4 card">
        ...
        <h1 class="h3 mb-0 text-warning font-weight-bold"> <i class="fas fa-minus-square"></i> Pagos dados de baja<br>
            <small class="text-dark">Pagos quitados de la lista de aceptados.</small>
        </h1>
                ...
                <tbody>
                    @foreach ($pagos as $pago)
                        <tr>
                            ...
                            <td style="vertical-align:middle;" class="bg-warning  text-center font-weight-bold"><i
                                    class="fas fa-money-bill-alt"></i> S/. {{ $pago->monto }}</td>
                            <td style="vertical-align:middle;" class="text-center">
                                <span class="badge badge-warning">
                                <i class="fas fa-minus-circle"></i> <br> dado de baja
                                </span>
                                <br>
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('admin.pago.actualizar', $pago) }}" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label for="mensaje">Mensaje de re-confirmación:</label>
