...
@section('content')
    ...
    <div class="mb-4 card">
        ...
        <h1 class="h3 mb-0 text-success font-weight-bold"> <i class="fas fa-check-square"></i> Pagos confirmados<br><small
                class="text-success">Lista de pagos aceptados y contabilizados.</small></h1>
        ...
        <a href="{{ route('home') }}" class="btn btn-sm btn-light shadow-sm ">
            <i class="fas fa-check-circle text-white-50"></i> Página Principal <i class="fas fa-house-user"></i>
        </a>
    </div>
                    ...
                    @foreach ($pagos as $pago)
                        <tr>
                            ...
                            <td>
                                ...
                                {{-- {{ dd($pago->navegates)}} --}}
                                {{-- Descargar archivo --}}
                                <a href="{{ asset($pago->archivo) }}" class="btn btn-primary float-right btn-sm"
                                    target="_blank" title="Ver archivo adjunto">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                {{-- OPERACION --}}
                                                <div class="card">
                                                    <h5 class="card-header bg-success text-white"># Operación:
                                                        {{ $pago->num_op }}</h5>
                                                    <div class="card-body">
                            ...
                            <td style="vertical-align:middle;" class="bg-success text-white text-center font-weight-bold"><i
                                    class="fas fa-money-bill-alt"></i> S/. {{ $pago->monto }}</td>
                            <td style="vertical-align:middle;" class="text-center"><span class="badge badge-primary">
                                    <i class="fas fa-check-circle"></i> <br>ACEPTADO
                                    <br>CONTABILIZADO</span>
                                    <br>
                                <small class="text-center font-weight-bold">{{ $pago->updated_at }}</small>
                            </td>
